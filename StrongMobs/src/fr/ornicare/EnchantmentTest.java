...
import net.minecraft.server.v1_4_R1.EnchantmentSlotType;
...
public class EnchantmentTest extends Enchantment
{
    ...
    public EnchantmentTest(int par1, int par2, int par3)
    {
    ...
    {
        return this.damageType == 0 ? MathHelper.floor((float)par1 * 2.75F) : (this.damageType == 1 && par2EntityLiving.getMonsterType() == EnumMonsterType.UNDEAD ? MathHelper.floor((float)par1 * 4.5F) : (this.damageType == 2 && par2EntityLiving.getMonsterType() == EnumMonsterType.ARTHROPOD ? MathHelper.floor((float)par1 * 4.5F) : 0));
    }
    ...
    public boolean func_92089_a(ItemStack par1ItemStack) //can enchant item
    {
        return true;
    }
}
